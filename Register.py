...
class Register:
    def __init__(self, home):
        ...
        #===Bg Image===
        self.bg=ImageTk.PhotoImage(file="F:\Student Management system\Images/6.1.jpg")
        bg =Label(self.home, image=self.bg).place(x=250, y=0, relwidth=1,relheight=1)
        #===LEFT Images===
        self.left=ImageTk.PhotoImage(file="F:\Student Management system\Images/left.jpg")
        ...
        self.btn_img=ImageTk.PhotoImage(file="F:\Student Management system\Images/register.png")
